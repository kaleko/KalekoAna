#ifndef LARLITE_MC_CCNUMU_MUONMCTRACKEXITINGFILTER_CXX
#define LARLITE_MC_CCNUMU_MUONMCTRACKEXITINGFILTER_CXX

#include "MC_CCnumu_MuonMCTrackExitingFilter.h"

namespace larlite {

    bool MC_CCnumu_MuonMCTrackExitingFilter::initialize() {
    ...
    bool MC_CCnumu_MuonMCTrackExitingFilter::analyze(storage_manager* storage) {
        ...
        for (auto const& mct : *ev_mctrack) {
            ...
            // Enforce the muon is exiting the fiducial volume.
    ...
    bool MC_CCnumu_MuonMCTrackExitingFilter::finalize() {

        std::cout << _n_total_events << " total events analyzed, "
                  << _n_kept_events << " events passed MC_CCnumu_MuonMCTrackExitingFilter." << std::endl;
