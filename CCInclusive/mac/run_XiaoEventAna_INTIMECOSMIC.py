...
my_proc.set_ana_output_file("XiaoEventAna_out_INTIMECOSMIC.root")
...
myxiao.setRunningOnData(True) #this saves mc NEUTRINO information, kCorsikaInTime doesn't have neutrinos
myxiao.setInputType(fmwk.kCorsikaInTime)#fmwk.kBNBCosmic fmwk.kCorsikaInTime
